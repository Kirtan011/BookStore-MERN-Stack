  ...
  return (
    <div className='py-4 mx-5'>
      ...
      <div className='flex justify-center items-center '>
        <h1 className='text-6xl my-8 font-reenie text-black'> Edit Book Details</h1>
      </div>
      {loading ? (
        <Spinner />
      ) : (
        <div className='flex flex-col  border-black  rounded-xl w-[600px] p-4 mx-auto transition duration-500 ease-in-out hover:scale-[1.02] hover:shadow-[0px_0px_50px_rgba(0,0,0,0.6)] shadow-[0px_0px_0px_rgba(0,0,0,0.6)]'>
          ...
          <button
            className="my-6 w-[15em] text-3xl font-reenie h-12 bg-red-500 rounded-lg cursor-pointer select-none text-white
